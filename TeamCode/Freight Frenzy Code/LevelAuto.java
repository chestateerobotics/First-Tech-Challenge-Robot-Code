...
public class LevelAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            int num = (int)calculateEncoders(609.6);
            while(carousel.getCurrentPosition() <= num){
                moveForward(0.1);
    ...
    private void moveForward(double speed){
        mecanumDrive.driveMecanum(0, speed, -0.01);
    }
