...
class MecanumDrive {
    ...
    void init(HardwareMap hwMap) {
        frontLeft = hwMap.get(DcMotor.class, "motorFrontLeft");
        frontLeft.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        frontRight = hwMap.get(DcMotor.class, "motorFrontRight");
        frontRight.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        backLeft = hwMap.get(DcMotor.class, "motorBackLeft");
        backLeft.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        backRight = hwMap.get(DcMotor.class, "motorBackRight");
