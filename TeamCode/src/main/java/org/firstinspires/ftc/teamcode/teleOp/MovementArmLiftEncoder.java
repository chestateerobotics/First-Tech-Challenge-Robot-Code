...
@TeleOp
@Config
public class MovementArmLiftEncoder extends LinearOpMode {
    private MecanumDrive mecanumDrive = new MecanumDrive();
    private double maxSpeed = 1;
    public DcMotor rightLift;
    public DcMotor slideLift;
    ...
    public void runOpMode() {
        ...
        slideLift = hardwareMap.get(DcMotor.class, "slideLift");
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad1.dpad_up)
            {
                slideLift.setTargetPosition(2000);
                slideLift.setPower(1);
            }else if(gamepad1.dpad_down)
            {
                ...
                int num = slideLift.getCurrentPosition();
                slideLift.setTargetPosition(num);
            }
